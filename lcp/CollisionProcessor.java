...
public class CollisionProcessor {
    ...
    public void processCollisions( double dt ) {
        ...
        if ( contacts.size() > 0  && doLCP.getValue() ) {
            ...
            // TODO: obj3 Compute velocity update with iterative solve of contact constraint matrix.
            
			/**
			 * J 2k*3n  Minv 3n*3n  Jt 3n*2k 
			 * D 2k*1   b 2k*1      lambda 2k*1 
            ...
            for (Contact c: contacts) {
                ...
                double[] f = {c.body1.force.x, c.body1.force.y, c.body1.torque, c.body2.force.x, c.body2.force.y, c.body2.torque};       
            ...
            {
            	// TODO: obj4 randomize the order of inner loop, boolean parameter was added in the control panel
     ...
     * TODO: obj2 This needs to be improved as the n-squared block test is too slow!
     * @param body1
     * @param body2
     */
    private void narrowPhase( RigidBody body1, RigidBody body2 ) {
        if ( ! useBVTree.getValue() ) {
            ...
            // TODO: obj2 implement code to use hierarchical collision detection on body pairs 
