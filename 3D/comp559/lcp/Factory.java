...
public class Factory {
    ...
    public void setImageBlocker( ImageBlocker blocker ) {
        ...
        seed.set( blocker.width*0.5, -blocker.height*0.2, blocker.thickness*0.1);
    }
    ...
    private void generateBody() {     
        ...
        body.x0.set( tmp );                        
        body.x.set( tmp );            
        body.theta.set(rand.nextDouble() * Math.PI*2,rand.nextDouble() * Math.PI*2,rand.nextDouble() * Math.PI*2);
        body.omega.set((2*rand.nextDouble() - 1) * angularVelocityScale.getValue(),(2*rand.nextDouble() - 1) * angularVelocityScale.getValue(),(2*rand.nextDouble() - 1) * angularVelocityScale.getValue());
